...
describe('generateString', function () {
  ...
  context.only('with a pattern that cannot be handled and mocker without "onUnknownPattern"', function () {
  ...
  context.only('with a pattern that cannot be handled and a mocker with "onUnknownPattern"', function () {
